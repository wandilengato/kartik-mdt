...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:fetchEMSIncidents"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    L11_2 = "SELECT * FROM mdt_ems_incidents "
    L12_2 = L7_2
    ...
    L13_2 = "SELECT COUNT(*) as count FROM mdt_ems_incidents "
    L14_2 = L7_2
    L13_2 = L13_2 .. L14_2
    L14_2 = MySQL
    L14_2 = L14_2.query
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:fetchEMSIncidentDataByIncidentId"
function L2_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2, L13_2, L14_2, L15_2, L16_2, L17_2, L18_2, L19_2
  if A1_2 then
    L2_2 = A1_2.incidentId
    L3_2 = "SELECT * FROM mdt_ems_incidents WHERE incidentId = ?"
    L4_2 = {}
    L5_2 = L2_2
    L4_2[1] = L5_2
    L5_2 = MySQL
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:addNewEMSIncident"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      ...
      L14_2 = L2_2.timeline
      L13_2 = L13_2(L14_2)
      L14_2 = "INSERT INTO mdt_ems_incidents (title, medicId, location, priority, description, dateTime, evidences, peopleInvolved, vehiclesInvolved, status, timeline) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
      L15_2 = {}
      L16_2 = L3_2
      L17_2 = L5_2
      L18_2 = L4_2
      ...
      L19_2 = "ems_incidents"
      L20_2 = "\240\159\154\145 EMS Incident Created"
      L21_2 = nil
      L22_2 = 5763719
      L23_2 = {}
      L24_2 = {}
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:saveEMSIncident"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      ...
      L13_2 = A1_2.timeline
      L12_2 = L12_2(L13_2)
      L13_2 = "UPDATE mdt_ems_incidents SET title = ?, location = ?, description = ?, evidences = ?, peopleInvolved = ?, vehiclesInvolved = ?, status = ?, priority = ?, timeline = ?, bodyData = ? WHERE incidentId = ?"
      L14_2 = {}
      L15_2 = L2_2
      L16_2 = L3_2
      L17_2 = L4_2
      ...
      if L16_2 > 0 then
        ...
        L17_2 = "ems_incidents"
        L18_2 = "\226\156\143\239\184\143 EMS Incident Edited"
        L19_2 = nil
        L20_2 = 3447003
        L21_2 = {}
        L22_2 = {}
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:deleteEMSIncident"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      L2_2 = A1_2.incidentId
      L3_2 = "DELETE FROM mdt_ems_incidents WHERE incidentId = ?"
      L4_2 = {}
      L5_2 = L2_2
      L4_2[1] = L5_2
      L5_2 = MySQL
      ...
      if L6_2 > 0 then
        L6_2 = SendDiscordLog
        L7_2 = "ems_incidents"
        L8_2 = "\240\159\151\145\239\184\143 EMS Incident Deleted"
        L9_2 = nil
        L10_2 = 15158332
        L11_2 = {}
        L12_2 = {}
