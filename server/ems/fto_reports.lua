...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:fetchEMSFTOReports"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    L10_2 = "SELECT * FROM mdt_ems_fto_reports "
    L11_2 = L6_2
    ...
    L12_2 = "SELECT COUNT(*) as count FROM mdt_ems_fto_reports "
    L13_2 = L6_2
    L12_2 = L12_2 .. L13_2
    L13_2 = MySQL
    L13_2 = L13_2.query
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:fetchEMSFTOReportDataByReportId"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      L2_2 = A1_2.ReportId
      L3_2 = "SELECT * FROM mdt_ems_fto_reports WHERE id = ?"
      L4_2 = {}
      L5_2 = L2_2
      L4_2[1] = L5_2
      L5_2 = MySQL
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:createEMSFTOReport"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      ...
      L13_2 = L2_2.status
      L14_2 = "INSERT INTO mdt_ems_fto_reports (trainee_name, fto_name, date, shift, phase, categories, overall_performance, strengths, areas_for_improvement, additional_comments, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
      L15_2 = {}
      L16_2 = L3_2
      L17_2 = L4_2
      L18_2 = L5_2
      ...
      L19_2 = "ems_fto_report"
      L20_2 = "\240\159\147\157 EMS FTO Report Created"
      L21_2 = nil
      L22_2 = 5763719
      L23_2 = {}
      L24_2 = {}
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:saveEMSFTOReport"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      ...
      L14_2 = "UPDATE mdt_ems_fto_reports SET trainee_name = ?, fto_name = ?, date = ?, shift = ?, phase = ?, categories = ?, overall_performance = ?, strengths = ?, areas_for_improvement = ?, additional_comments = ? WHERE id = ?"
      L15_2 = {}
      L16_2 = L4_2
      L17_2 = L5_2
      L18_2 = L6_2
      ...
      if L17_2 > 0 then
        ...
        L18_2 = "ems_fto_report"
        L19_2 = "\226\156\143\239\184\143 EMS FTO Report Edited"
        L20_2 = nil
        L21_2 = 3447003
        L22_2 = {}
        L23_2 = {}
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:approveEMSFTOReport"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      L2_2 = A1_2.reportId
      L3_2 = "UPDATE mdt_ems_fto_reports SET status = 'approved' WHERE id = ?"
      L4_2 = {}
      L5_2 = L2_2
      L4_2[1] = L5_2
      L5_2 = MySQL
      ...
      if L6_2 > 0 then
        L6_2 = SendDiscordLog
        L7_2 = "ems_fto_report"
        L8_2 = "\226\156\133 EMS FTO Report Approved"
        L9_2 = nil
        L10_2 = 3066993
        L11_2 = {}
        L12_2 = {}
...
L0_1 = L0_1.callback
L0_1 = L0_1.register
L1_1 = "kartik-mdt:server:rejectEMSFTOReport"
function L2_1(A0_2, A1_2)
  ...
  if A1_2 then
    ...
    if L2_2 then
      ...
      L4_2 = "UPDATE mdt_ems_fto_reports SET status = 'rejected', rejection_reason = ? WHERE id = ?"
      L5_2 = {}
      L6_2 = L3_2
      L7_2 = L2_2
      L5_2[1] = L6_2
      ...
      if L7_2 > 0 then
        L7_2 = SendDiscordLog
        L8_2 = "ems_fto_report"
        L9_2 = "\226\157\140 EMS FTO Report Rejected"
        L10_2 = nil
        L11_2 = 15158332
        L12_2 = {}
        L13_2 = {}
