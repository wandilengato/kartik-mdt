...
function L0_1(A0_2, A1_2, A2_2)
  ...
  if "" ~= A0_2 then
    ...
    L14_2 = L14_2.scalar
    L14_2 = L14_2.await
    L15_2 = "SELECT COUNT(*) FROM characters WHERE "
    L16_2 = L9_2
    L15_2 = L15_2 .. L16_2
    L16_2 = L11_2
    L14_2 = L14_2(L15_2, L16_2)
    ...
    L14_2 = L14_2.scalar
    L14_2 = L14_2.await
    L15_2 = "SELECT COUNT(*) FROM characters"
    L14_2 = L14_2(L15_2)
    L4_2 = L14_2
    L14_2 = MySQL
    L14_2 = L14_2.query
...
function L0_1(A0_2, A1_2)
  ...
  L2_2 = "UPDATE characters SET photo = ? WHERE stateId = ?"
  L3_2 = {}
  L4_2 = A1_2
  L5_2 = A0_2
  L3_2[1] = L4_2
...
function L0_1(A0_2)
  ...
  L1_2 = "SELECT COUNT(*) as count FROM characters WHERE stateId = ?"
  L2_2 = MySQL
  L2_2 = L2_2.query
  L2_2 = L2_2.await
  L3_2 = L1_2
...
function L0_1(A0_2, A1_2)
  ...
  L2_2 = "WHERE mdt_units.citizenid = characters.stateId"
  L3_2 = {}
  if "" ~= A0_2 then
    L4_2 = L2_2
    L5_2 = [[
 AND (
  ...
  for L12_2, L13_2 in L8_2, L9_2, L10_2, L11_2 do
    ...
    L20_2 = L14_2.firstName
    if not L20_2 then
      L20_2 = "Unknown"
    end
    L21_2 = " "
    L22_2 = L14_2.firstName
    if not L22_2 then
      L22_2 = ""
    end
...
function L0_1(A0_2, A1_2, A2_2)
  ...
  L4_2 = A2_2
  L5_2 = "' AND mdt_units.citizenid = characters.stateId"
  L3_2 = L3_2 .. L4_2 .. L5_2
  L4_2 = {}
  if "" ~= A0_2 then
    L5_2 = L3_2
 ...
 AND (
  ...
  for L13_2, L14_2 in L9_2, L10_2, L11_2, L12_2 do
    ...
    if L20_2 > 10 then
      ...
      L23_2 = L23_2 - 9
      L24_2 = #L18_2
      L21_2, L22_2, L23_2, L24_2, L25_2 = L21_2(L22_2, L23_2, L24_2)
      L20_2[1] = L21_2
      L20_2[2] = L22_2
      L20_2[3] = L23_2
      L20_2[4] = L24_2
    ...
    L22_2.id = L23_2
    L23_2 = L14_2.stateId
    L22_2.citizenId = L23_2
    L23_2 = L15_2.firstName
    if not L23_2 then
      L23_2 = "Unknown"
    end
    L24_2 = " "
    L25_2 = L15_2.firstName
    if not L25_2 then
      L25_2 = ""
    end
    ...
    L23_2 = L14_2.photo
    L22_2.photo = L23_2
    L23_2 = L14_2.totalHours
    L22_2.totalDutyHours = L23_2
    L23_2 = L14_2.callsign
    L22_2.callsign = L23_2
    L22_2.dutyRecords = L19_2
    L20_2(L21_2, L22_2)
  end
  L9_2 = fetchUnitCount
  L10_2 = L3_2
...
function L0_1(A0_2, A1_2)
  ...
  for L10_2, L11_2 in L6_2, L7_2, L8_2, L9_2 do
    ...
    L13_2 = L11_2.firstName
    if not L13_2 then
      L13_2 = "Unknown"
    end
    L14_2 = " "
    L15_2 = L11_2.lastName
    if not L15_2 then
      L15_2 = ""
    end
...
function L0_1(A0_2, A1_2, A2_2)
  ...
  if "" ~= A0_2 then
    L3_2 = [[
            WHERE LOWER(vehicles.plate) LIKE LOWER(?) OR
            LOWER(characters.stateId) LIKE LOWER(?)
        ]]
    L5_2 = {}
    L6_2 = "%"
    L7_2 = A0_2
...
function L0_1(A0_2)
  ...
  L2_2 = {}
  if "" ~= A0_2 then
    L1_2 = " WHERE LOWER(vehicles.plate) LIKE LOWER(?) OR LOWER(characters.stateId) LIKE LOWER(?) "
    L3_2 = {}
    L4_2 = "%"
    L5_2 = A0_2
    L6_2 = "%"
  ...
  L3_2 = "SELECT COUNT(*) AS count FROM vehicles LEFT JOIN characters ON vehicles.owner = characters.charId "
  L4_2 = L1_2
  L3_2 = L3_2 .. L4_2
  L4_2 = MySQL
  L4_2 = L4_2.query
...
function L0_1(A0_2, A1_2, A2_2)
  ...
  L4_2 = {}
  if "" ~= A0_2 then
    L5_2 = " WHERE LOWER(characters.firstName) LIKE LOWER(?) "
    L6_2 = " OR LOWER(characters.lastName) LIKE LOWER(?) "
    L7_2 = " OR LOWER(characters.stateId) LIKE LOWER(?) "
    L8_2 = " OR warrants.id = ? "
...
function L0_1(A0_2)
  ...
  L2_2 = {}
  if "" ~= A0_2 then
    L3_2 = " WHERE LOWER(characters.firstName) LIKE LOWER(?) "
    L4_2 = " OR LOWER(characters.lastName) LIKE LOWER(?) "
    L5_2 = " OR LOWER(characters.stateId) LIKE LOWER(?) "
    L6_2 = " OR warrants.id = ? "
