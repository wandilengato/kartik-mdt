...
CreateThread(function()
    updatePlayerData(QBCore.Functions.GetPlayerData())
    setupMDTData()
end)
...
function getVehicleDisplayName(hash)
    ...
    if QBCore and QBCore.Shared and QBCore.Shared.VehicleHashes then
        local displayName = QBCore.Shared.VehicleHashes[hash] and QBCore.Shared.VehicleHashes[hash].name or GetDisplayNameFromVehicleModel(hash)
        return displayName
    else
